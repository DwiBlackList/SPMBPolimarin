...
<div class="p-5 bg-primary text-white">
    <h1>Seleksi Jalur Mandiri</h1>
    <p>Seleksi Jalur Mandiri merupakan jalur seleksi melalui tes akademik bagi calon mahasiswa baru yang dapat diikuti oleh lulusan SMA/SMK/MA tahun 2021, 2022, atau 2023.</p>
</div>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p>Panduan Seleksi Jalur Mandiri <strong>download</strong></p>
                                <p>Panduan Tes Akademik Jalur Mandiri <strong>download</strong></p>
                                <p>Perubahan Penetapan SPI Jalur Mandiri <strong>download</strong></p>
                            </div>
                        </div>
                    </div>
