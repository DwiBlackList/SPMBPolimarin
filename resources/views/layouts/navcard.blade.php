<div class="col-md-4 col-12">
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <a href="https://akademik.polimarin.ac.id/pmb/" target="_blank">
                <div class="d-flex align-content-center">
                    <span class="material-symbols-outlined">
                        arrow_forward_ios
                    </span> Portal SPMB
            ...
            <hr>
            <a href="{{ route('jadwal-pendaftaran') }}">
                <div class="d-flex align-content-center">
                    <span class="material-symbols-outlined">
                        arrow_forward_ios
            ...
            <hr>
            <a href="{{ route('seleksi-jalur-prestasi') }}">
                <div class="d-flex align-content-center">
                    <span class="material-symbols-outlined">
                        arrow_forward_ios
            ...
            <hr>
            <a href="{{ route('seleksi-jalur-mandiri') }}">
                <div class="d-flex align-content-center">
                    <span class="material-symbols-outlined">
                        arrow_forward_ios
